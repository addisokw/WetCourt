# Wet Court — turret AIM firmware (pan/tilt), MicroPython.
...
# it): same hardware, same AIM contract, same role. Firing is a SEPARATE board
# (role `squirt`, firmware/squirt/) because the servo board claims the NanoC6's
# only Grove I2C pins, leaving no GPIO for the relay.
#
# The role-agnostic protocol client is the shared ../micropython/wetline.py;
# this file is just the servo driver + the AIM handler.
#
...
init_servos()
wetline.run("turret", FW_VERSION, {"AIM": handle_aim})
