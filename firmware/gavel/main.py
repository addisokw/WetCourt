...
#
# One GAVEL = one rap: REST → RAISE → STRIKE → REST, acked after the swing
# completes. The role-agnostic protocol client is the shared
# ../micropython/wetline.py; this file is the servo driver + the GAVEL/GJOG
# handlers.
#
...
FW_VERSION = "0.4"           # 0.4 = direct-PWM servo (no 8-Servos board)
...
def handle_gavel(args):
    ...
    — one rap, then ack. (Direct PWM has no presence detection: a missing or
